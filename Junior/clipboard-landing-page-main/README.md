...
- Solution URL: [GitHub](https://github.com/neonita/Frontend-Mentor/tree/main/Junior/clipboard-landing-page-main)
...
- [BEM (Block Element Modifier)](http://getbem.com/naming/) - Convention for class naming
- Flexbox
- CSS Grid
